  ...
  return (
    <section className="rounded-[28px] border border-black/5 bg-bg-surface p-5 shadow-sm sm:p-6 lg:p-8">
      <div className="flex flex-col gap-4 border-b border-black/5 pb-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        {!formOpen && (
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-bg-dark px-4 py-3 text-sm font-medium text-white transition hover:bg-neutral-800"
          >
      ...
      <div className="mt-6 space-y-6">
        {loading && (
          <div className="grid gap-4">
            {[1, 2].map((item) => (
              <div
                key={item}
                className="rounded-3xl border border-neutral-200 bg-neutral-50 p-5 animate-pulse"
              >
        ...
        {!loading && formOpen && (
          <div className="rounded-3xl border border-border-muted/20 bg-amber-50/50 p-4 sm:p-5">
        ...
        {!loading && !formOpen && addresses.length === 0 && (
          <div className="rounded-[28px] border border-dashed border-neutral-300 bg-neutral-50 px-6 py-12 text-center">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-black/5">
            ...
            <button
              ...
              className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-neutral-900 px-4 py-3 text-sm font-medium text-white transition hover:bg-neutral-800"
            >
              <Plus className="h-4 w-4" />
              Add address
            </button>
                    ...
                    <div className="flex flex-wrap gap-2 sm:justify-end">
                      {!addr.isDefault && (
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-sm font-medium text-amber-800 transition hover:bg-amber-100 disabled:opacity-60"
                        >
                          {isDefaulting ? (
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl border border-black/10 bg-white px-3 py-2 text-sm font-medium text-neutral-700 transition hover:bg-neutral-100"
                      >
